...
<head>
  ...
  <title>You made a payment - CratoByte</title>
  <style>
...
<div class='container'>
  <div class='mail-body'>
    ...
    <h1 style='color:#fff;text-align:center;'>You sent $volume ".$assetData['unit']."</h1>
    <p style='display:flex;'>Amount: <span style='margin-left:auto;opacity:.7;'>$".number_format($amount, 2)."</span></p>
    <p style='display:flex;'>To: <span style='margin-left:auto;opacity:.7;'>".substr($wallet_addr, 0,10)."...</span></p>
    ...
    <p style='color:#fff;margin:0;margin-top:25px;'>View transaction at <a href='".$link."'>".$link."</a></p>
    <p style='color:#fff;margin:0;'>Thank you for choosing CratoByte wallet!</p>
  </div>
</div>
</body>
</html>
";
// subject
$subject = "You made a payment - CratoByte";
// Headers
